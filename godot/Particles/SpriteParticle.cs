...
namespace Nova.Particles {
	...
	/// <summary>
	/// A simple implementation of IParticle2D that wraps a sprite.
	/// </summary>
	public class SpriteParticle : Sprite, IParticle2D {
		...
		void IParticle2D.SetTexture(Texture texture) => Texture = texture;
